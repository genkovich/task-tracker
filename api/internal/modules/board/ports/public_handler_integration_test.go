...
// AC-10's executable check lives in board_integration_test.go
// (TestPublicRoutes_MutatingMethodsRefused): it needs the fully wired
// server.New router — on this file's public-handler-only fixture a 404 is
// guaranteed by the empty router and proves nothing (review 2026-08-21
// re2, #10).
